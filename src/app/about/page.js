    ...
    >
      <div className="flex flex-col items-center justify-center h-full mt-10 md:mt-20">
        <div className="flex flex-col items-center text-center mt-8 mb-10">
          <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-snug max-w-2xl">
  ...
  return (
    <section className="px-6 sm:px-12 md:px-16 lg:px-24 py-16 w-full bg-[url('/recognition-bg.png')] bg-no-repeat bg-center bg-cover">
      <div className="flex items-center justify-center text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-4xl font-bold leading-snug text-[#E8E8E8]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
        <div className="relative w-full h-64 sm:h-80 md:h-auto rounded-2xl overflow-hidden shadow-lg">
          <Image
            src="/av-lab-3.png"
        ...
        <div className="w-full h-auto bg-[url('/choices.png')] bg-no-repeat bg-center bg-cover p-6 sm:p-8 rounded-2xl shadow-lg space-y-6 flex flex-col justify-between">
          <div className="space-y-6">
            <h3 className="text-2xl sm:text-3xl md:text-4xl text-left text-[#E8E8E8] font-bold leading-snug">
          ...
          <button className="group self-start flex items-center cursor-pointer mt-4 px-5 sm:px-6 py-2 sm:py-3 rounded-[30px] bg-white text-lg sm:text-xl md:text-2xl lg:text-[28px] text-[#0A3253] font-bold hover:bg-[#0A3253] hover:text-white transition">
            <span>Discover More About Us</span>
            <svg
              viewBox="0 0 46 22"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="ml-3 sm:ml-4 text-[#0A3253] group-hover:text-white w-6 h-3 sm:w-9 sm:h-5"
            >
              <path
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center mt-8 gap-4">
        <div className="bg-gradient-to-r from-[#2B2B2B] to-[#983232] hover:from-[#0A3253] hover:to-[#0A3253] rounded-[20px] flex items-center justify-center h-24 sm:h-[120px] w-full sm:w-[300px] md:w-[400px] lg:w-[500px] cursor-pointer px-4">
          <p className="text-[#E8E8E8] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center">
            7+ Years In Business
          </p>
        </div>
        <div className="group bg-white hover:bg-[#0A3253] rounded-[20px] flex items-center justify-center h-24 sm:h-[120px] w-full sm:w-[300px] md:w-[400px] lg:w-[500px] cursor-pointer px-4">
          <p className="text-black group-hover:text-white font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center">
  ...
  return (
    <div className="px-6 md:px-24 py-12 w-full h-full  items-center justify-center text-center bg-black">
      <div className="flex flex-col max-w-7xl gap-6 p-6 sm:p-10 mx-auto bg-[url('/members-bg.png')] bg-cover bg-center bg-no-repeat justify-center rounded-[20px] sm:rounded-[30px] items-center mt-6 sm:mt-10">
        ...
        <p className="text-2xl  md:text-5xl  font-bold text-white mt-6">
          55+ Team Members
        </p>
      </div>
    </div>
