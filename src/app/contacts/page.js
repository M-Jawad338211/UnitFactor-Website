          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-30 text-sm text-gray-300 mt-4">
              <div className="flex items-center gap-4">
                ...
                >
                  <g clip-path="url(#clip0_1192_1285)">
                    <path
              ...
              <div className="flex items-center gap-4">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1192_1288)">
                    <path
...
function Partners() {
  return (
    <div className="p-24 w-full h-full items-center justify-center text-center bg-black">
      <div className="max-w-7xl p-10 mx-auto bg-[url('/solutions-bg.png')] bg-cover bg-center bg-no-repeat rounded-[30px]  mt-10">
        <div className="w-full h-auto  p-8  space-y-2 flex flex-col justify-between">
          <div className="space-y-6 flex flex-col items-center">
            <h3 className="text-[40px] text-center text-white max-w-lg font-bold leading-[150%] tracking-[0]">
