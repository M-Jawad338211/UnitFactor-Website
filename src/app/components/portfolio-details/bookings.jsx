      ...
      >
        <div className="w-full h-auto space-y-6 flex flex-col justify-between">
          <div className="space-y-4 flex flex-col items-center">
            ...
            <Link
              href="/contacts"
              className="bg-[#983232] hover:bg-[#0A3253] transition-colors 
              text-white text-base md:text-xl xl:text-3xl 2xl:text-4xl font-bold px-6 py-3 rounded-2xl mt-6 cursor-pointer active:scale-95 duration-150 ease-in-out"
            >
              Book a free trial
            </Link>
          </div>
