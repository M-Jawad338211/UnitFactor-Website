...
export default function Recognitions() {
  ...
  return (
    <section className="px-6 sm:px-12 md:px-16 lg:px-28 py-12 md:py-16 lg:py-20 xl:py-28 w-full bg-[url('/recognition-bg.png')] bg-no-repeat bg-center bg-cover">
      ...
      <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-2 items-stretch mt-16">
        ...
        <div className="w-full h-auto bg-[url('/choices.png')] bg-no-repeat bg-center bg-cover p-6 xl:p-10 2xl:p-16 rounded-2xl shadow-lg space-y-6 flex flex-col justify-between">
          ...
          <button className="group self-start flex items-center cursor-pointer mt-4 px-4 xl:px-8 py-2 xl:py-4 rounded-[30px] bg-white text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl 2xl:text-[28px] text-[#0A3253] font-bold hover:bg-[#983232] hover:text-white transition w-auto">
            ...
            <svg
              ...
              className="ml-3 sm:ml-4 text-[#0A3253] group-hover:text-white w-[32px] h-[14px] md:w-[40px] md:h-[18px] xl:w-[46px] xl:h-[22px]"
            >
              <path
