export default function Solutions() {
  ...
  return (
    <div className="flex flex-col px-4 sm:px-12 lg:px-16 xl:px-28 py-12 sm:py-20  lg:py-28 w-full h-full bg-[url('/Rectangle.png')] bg-no-repeat bg-center bg-cover overflow-hidden">
      <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-left font-normal font-designer text-white mb-4">
        OUR SOLUTION
      </h2>
      ...
      <div className="w-full mx-auto py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className={`group bg-gradient-to-b from-[#D9D9D9] to-[#D9D9D9] hover:from-[#983232] hover:to-[#000000]  
            ...
            >
              <div className="p-6 flex flex-col h-full text-center">
                <h3 className="text-lg sm:text-xl md:text-xl xl:text-[24px] font-bold text-black group-hover:text-white mb-3 md:min-h-14">
                  {service.title}
                </h3>
                <p className="text-sm sm:text-base md:text-lg xl:text-xl text-[#717171] group-hover:text-white mb-5 font-medium md:leading-5 xl:leading-relaxed">
                  {service.description}
                </p>
